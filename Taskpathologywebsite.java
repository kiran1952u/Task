	...
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(5000);
          JavascriptExecutor js = (JavascriptExecutor) driver;
           ...
           Thread.sleep(2000);
           WebElement buttonElement = driver.findElement(By.xpath("/html/body/div[2]/div/main/div[2]/div[2]/div/div[2]/div[2]/button[2]/span[1]"));

           // Perform an action on the button (e.g., click)
           buttonElement.click();
